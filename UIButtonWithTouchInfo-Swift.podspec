...
Use it for fun and projects.
  ...
  s.author           = { 'Developer iOS' => 'skype:camopu-ympo, http://camopu.rhorse.ru/ios' }
  s.source           = { :git => 'https://github.com/Developer iOS/UIButtonWithTouchInfo-Swift.git', :tag => s.version.to_s }
